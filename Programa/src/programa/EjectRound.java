 ...
 * @author USER
 */
public final class EjectRound extends javax.swing.JFrame {
    DefaultTableModel m;
    ...
    private void initComponents() {
        ...
        txtCuantun = new rojeru_san.rsfield.RSTextField();
        ...
        jLabel6.setText("Proceso RoundR ");
        ...
        rSPanelGradiente3.add(txtProceso, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 140, 100, 30));

        jLabel2.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Proceso");
        rSPanelGradiente3.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 140, -1, -1));

        jLabel3.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Prioridad");
        rSPanelGradiente3.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 200, 50, -1));
        ...
        rSPanelGradiente3.add(txtRafaga, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 190, 100, 30));

        txtCuantun.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        txtCuantun.setForeground(new java.awt.Color(0, 0, 0));
        txtCuantun.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtCuantun.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        txtCuantun.setPlaceholder("");
        rSPanelGradiente3.add(txtCuantun, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 240, 100, 30));
        ...
        rSPanelGradiente3.add(txtPrioridad, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 190, 100, 30));
        ...
        rSPanelGradiente3.add(txtTiempo, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 140, 100, 30));

        jLabel4.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("T Llegada");
        rSPanelGradiente3.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 140, -1, -1));
        ...
        rSPanelGradiente3.add(btnPreparar, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 240, 94, 30));
        ...
        Quantum.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        Quantum.setForeground(new java.awt.Color(255, 255, 255));
        Quantum.setText("Quantum");
        rSPanelGradiente3.add(Quantum, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 250, -1, -1));

        jLabel7.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Rafaga");
        rSPanelGradiente3.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 200, -1, -1));
    ...
    private void btnPrepararActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrepararActionPerformed
            ...
            if((txtProceso.getText().equals(""))||(txtRafaga.getText().equals(""))||(txtTiempo.getText().equals(""))||(txtPrioridad.getText().equals(""))||(txtCuantun.getText().equals(""))){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EjectRound.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new EjectRound().setVisible(true);
            }
        });
    }
    ...
    private rojeru_san.rsfield.RSTextField txtCuantun;
